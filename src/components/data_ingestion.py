...
## Initilize the data ingesation configuration
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            logging.info("Exeception occour at Data Ingestion Stage")
...
if __name__ == '__main__':
    ...
    train_arr, test_arr,_ = data_transfrom.initatite_data_transformation(train_data_path, test_data_path)
